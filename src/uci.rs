            ...
            "go" => {
                ...
                while i < parts.len() {
                    match parts[i] {
                        ...
                        "movetime" => {
                            let time = parts[i + 1].parse::<i128>().unwrap();
                        ...
                        "wtime" => {
                            is_competitive = true;
                            wtime = parts[i + 1].parse::<i128>().unwrap();
                            i += 2;
                        }
                        "winc" => {
                            is_competitive = true;
                            winc = parts[i + 1].parse::<i128>().unwrap();
                            i += 2;
                        }

                        "btime" => {
                            is_competitive = true;
                            btime = parts[i + 1].parse::<i128>().unwrap();
                            i += 2;
                        }

                        "binc" => {
                            is_competitive = true;
                            binc = parts[i + 1].parse::<i128>().unwrap();
                            i += 2;
                        }
                        _ => {
